...
* url = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsBehavioralHealthCodes"
* title = "ValueSet - Leap SLS Behavioral Health Codes"
* description = """
Leap SLS set of codes representing behavioral health conditions requiring special privacy protections
...
* url = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsSexualityAndReproductiveHealthCodes"
* title = "ValueSet - Leap SLS Sexuality and Reproductive Health Codes"
* description = """
Leap SLS set of codes representing sexuality and reproductive health requiring special privacy protections
...
* url = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsPsychiatricNotesCodes"
* title = "ValueSet - Leap SLS Psychiatric Notes Use Codes"
* description = """
Leap SLS set of codes representing psychiatric notes requiring special privacy protections. 
...
* url = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsOpioidCodes"
* title = "ValueSet - Leap SLS Opioid Codes"
* description = """
Leap SLS set of codes representing opioid abuse requiring special privacy protections.
...
* url = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsHallucinogenCodes"
* title = "ValueSet - Leap SLS Hallucinogen Codes"
* description = """
Leap SLS set of codes representing hallucinogen abuse requiring special privacy protections
...
* entry[=].fullUrl = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsHallucinogenCodes"
* entry[+].resource = LeapSlsOpioidCodes
* entry[=].fullUrl = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsOpioidCodes"
* entry[+].resource = LeapSlsBehavioralHealthCodes
* entry[=].fullUrl = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsBehavioralHealthCodes"
* entry[+].resource = LeapSlsSexualityAndReproductiveHealthCodes
* entry[=].fullUrl = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsSexualityAndReproductiveHealthCodes"
* entry[+].resource = LeapSlsPsychiatricNotesCodes
* entry[=].fullUrl = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsPsychiatricNotesCodes"
//* entry[+].resource = LeapSlsSensitiveCodes
//* entry[=].fullUrl = "http://johnmoehrke.github.io/SLSValueSets/ValueSet/LeapSlsSensitiveCodes"
